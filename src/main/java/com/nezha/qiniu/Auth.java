...
public class Auth {
    ...
    public static void main(String[] args) {
    	String accessKey = "DBDyvzcYa4O7gpAiwbXG2_d2xi5LoRIDVrhep6ky";
    	String secretKey = "WBuZWz_O57sKDOTI3PsCYrpF1HYq_0GLkCjCKjo9";
    	String bucket = "cnlivetest";
